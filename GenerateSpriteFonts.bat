...
DirectXTK\MakeSpriteFont\bin\Release\MakeSpriteFont.exe "Arabic Typesetting" InputLagTimer\res\fonts\timer\0016.spritefont /FontSize:16 /LineSpacing:-7 /CharacterSpacing:0
DirectXTK\MakeSpriteFont\bin\Release\MakeSpriteFont.exe "Arabic Typesetting" InputLagTimer\res\fonts\timer\0032.spritefont /FontSize:32 /LineSpacing:-15 /CharacterSpacing:0
